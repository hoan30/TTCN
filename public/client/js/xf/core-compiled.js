...
!(function (g, q, r) {
  XF.activate
    ...
    : (XF.browser ||
        (XF.browser = { browser: "", version: 0, os: "", osVersion: null }),
      (function () {
        var a = (function () {
        ...
        if (b && "RTL" == b.toUpperCase()) {
          ...
          0 < c.scrollLeft
            ? (a = "inverted")
            : ((c.scrollLeft = -1), -1 == c.scrollLeft && (a = "negative"));
          b.remove();
        }
      ...
      g.fn.extend({
        ...
        xfUniqueId: function () {
          var a = this.attr("id");
          a ||
            ((a = "js-XFUniqueId" + XF.getUniqueCounter()), this.attr("id", a));
          return a;
        },
              ...
              case "-webkit-sticky":
                ...
                if (
                  ("auto" !== e &&
                    ...
                    0.5 >= e && -0.5 <= e)) ||
                  ("auto" !== d &&
                    ((e = c.bottom - f.bottom - parseInt(d, 10)),
                    0.5 >= e && -0.5 <= e))
                )
                  return (a = b), !1;
            }
        ...
        normalizedScrollLeft: function (a) {
          ...
          switch (b) {
            case "negative":
              return 0 > c ? -c : 0;
            case "inverted":
              return (b = a.scrollWidth - c - a.offsetWidth), 0.5 > b ? 0 : b;
            default:
              return c;
          }
        },
      ...
      (function () {
        ...
        function c(e, d, h, k, m) {
          ...
          if (d.length)
            if (0 >= m) e[l](d), t();
              ...
              e.hasClass("is-transitioning") && e.trigger("xfTransitionEnd");
              ...
              if (
                ...
                if (void 0 === u)
                  for (u = {}, A = 0; A < x.length; A++)
                    u[x[A]] = z[x[A]] || "";
                if (0 == e[t]())
                  for (A in ((y = "0"), v)) v.hasOwnProperty(A) && (v[A] = "0");
                e.data(w, u).css("transition", "none")[l](d);
                x = e.css(x);
                u = x[t];
                if (0 == e[t]())
                  for (A in ((u = "0"), x)) x.hasOwnProperty(A) && (x[A] = "0");
                e[p](d);
                if (y != u) {
                  var C = k;
                  e.css(v);
        ...
        var f = {
          height:
            "height padding-top padding-bottom margin-top margin-bottom border-top-width border-bottom-width".split(
              " "
            ),
          width:
            "width padding-left padding-right margin-left margin-right border-right-width border-left-width".split(
              " "
            ),
        };
      ...
      g.extend(XF, {
        ...
        onPageLoad: function () {
          ...
          setTimeout(function () {
            g("[data-load-auto-click]").first().click();
          }, 100);
        ...
        isIOS: function () {
          return /iPad|iPhone|iPod/.test(navigator.userAgent) && !q.MSStream;
        },
        isIE: function () {
        ...
        layoutChange: function () {
          XF._layoutChangeTriggered ||
            ...
            setTimeout(function () {
              ...
              g(r.body).trigger("sticky_kit:recalc").trigger("xf:layout");
            }, 0));
        },
        ...
        updateVisitorCounts: function (a, b, c) {
          a &&
            ...
            XF.badgeCounterUpdate(g(".js-badge--alerts"), a.alerts_unviewed),
                ...
                f.shouldCountBeShown(a)
                  ? (d || h.data("original-href", e),
                    g("<img />")
                      ...
                      .attr("src", e))
                  : d && h.attr("href", d).removeData("original-href");
              });
            }
          }
        },
        ...
        unparseBbCode: function (a) {
          ...
          b.find(".bbCodeBlock--quote").each(function () {
            ...
            f.length
              ? c.replaceWith("<div>[QUOTE]" + f.html() + "[/QUOTE]</div>")
          ...
          b.find(".bbCodeBlock--code").each(function () {
            ...
            f.removeAttr("class");
            c.replaceWith(f.first().attr("data-language", e || "none"));
          });
          ...
          b.find('div[style*="text-align"]').each(function () {
            var c = g(this).css("text-align").toUpperCase();
            g(this).replaceWith(
              "[" + c + "]" + g(this).html() + "[/" + c + "]"
            );
          });
          b.find(
            "div[data-media-site-id][data-media-key], form[data-media-site-id][data-media-key]"
          ).each(function () {
            var c = g(this).data("media-site-id"),
              f = g(this).data("media-key");
            if (!c || !f) return !0;
            g(this).replaceWith("[MEDIA=" + c + "]" + f + "[/MEDIA]");
          });
          b.find(".bbCodeSpoiler").each(function () {
            var c = "";
            var f = g(this).find(".bbCodeSpoiler-button");
            if (f.length) {
              var e = g(this).find(".bbCodeSpoiler-content").html();
              f = f.find(".bbCodeSpoiler-button-title");
              f.length && (c = '="' + f.text() + '"');
              g(this).replaceWith("[SPOILER" + c + "]" + e + "[/SPOILER]");
            }
          });
          ...
          for (l in a)
            if (a.hasOwnProperty(l)) {
              ...
              XF.loadedScripts[p] ||
                ...
                d
                  ? (function (n) {
                      var t = g("<script>").prop({ src: n, async: !1 });
        ...
        ajax: function (a, b, c, f, e) {
          ...
          e &&
            ...
            e.skipDefaultSuccess && ((d = !1), delete e.skipDefaultSuccess),
        ...
        defaultAjaxSuccessError: function (a, b, c) {
          ...
          a.html &&
            ...
            ((b = "Errors were triggered when rendering this template:"),
        ...
        setupHtmlInsert: function (a, b, c) {
          if ("string" === typeof a || a instanceof g) a = { content: a };
            ...
            XF.Loader.load(a.js, a.css, function () {
              ...
              if (a.cssInline)
                for (e = 0; e < a.cssInline.length; e++)
                  g("<style>" + a.cssInline[e] + "</style>").appendTo("head");
              if (k) {
                var l;
                h = g.trim(h);
                if (!m)
              ...
              if ("function" !== typeof b)
                ...
                h = function (v) {
                  if (!x) {
                    x = !0;
                    for (var y = 0; y < d.length; y++) g.globalEval(d[y]);
                    a.jsState &&
        ...
        getMultiBarHtml: function (a) {
          ...
          g.isPlainObject(a) && (g.extend({}, b, a), a.html && (a = a.html));
          if ("string" == typeof a) a = g(g.parseHTML(a));
          else if (!(a instanceof g))
            throw Error(
            ...
            if (a.hasOwnProperty(e) && ((f[e] = a[e]), b.hasOwnProperty(e))) {
              ...
              switch (typeof f[e]) {
                case "string":
                  ...
                  break;
                case "number":
                  "number" != h && ((d = Number(d)), isNaN(d) && (k = !1));
                  break;
                case "boolean":
                  if ("boolean" != h)
                    switch (d) {
        ...
        logRecentEmojiUsage: function (a) {
          if (!XF.Cookie.isGroupConsented("optional")) return [];
          a = g.trim(a);
        ...
        autoFocusWithin: function (a, b, c) {
          ...
          f.length ||
            ...
            f.length ||
              ((b = a.is("form:not([data-no-auto-focus])")
                ? a
                : a.find("form:not([data-no-auto-focus])").first()),
              b.length &&
                (f = b
                  .find(":input, button")
                  .filter(":visible")
          ...
          for (b = 0; b < a.length; b++)
            (c = a[b].el),
              c.scrollLeft != a[b].left && (c.scrollLeft = a[b].left),
        ...
        bottomFix: function (a) {
          ...
          b
            ? b.append(a)
            : g(a).css({ position: "fixed", bottom: 0 }).appendTo("body");
        },
        ...
        pageLoadScrollFix: function () {
          if (!XF.Feature.has("overflowanchor") && q.location.hash) {
            var a = !1,
              b = function () {
                if (!a) {
                  var c = q.location.hash.replace(/[^a-zA-Z0-9_-]/g, "");
                  c = c ? g("#" + c) : g();
        ...
        jsStates: {
          ...
          fbSdk: function () {
            ...
            XF.loadScript(
              "https://connect.facebook.net/" + XF.getLocale() + "/sdk.js"
            );
            return !0;
          },
          twitter: function () {
          ...
          imgur: function () {
            ...
            XF.loadScript("//s.imgur.com/min/embed-controller.js", function () {
              g(r).on("xf:reinit", function (a, b) {
                imgurEmbed.tasks += g("blockquote.imgur-embed-pub").length;
                for (a = 0; a < imgurEmbed.tasks; a++)
                  imgurEmbed.createIframe(), imgurEmbed.tasks--;
              });
            });
            return !0;
          },
        ...
        getLocale: function () {
          var a = g("html").attr("lang").replace("-", "_");
          a || (a = "en_US");
          return a;
        },
        ...
        isEventTouchTriggered: function (a) {
          if (a) {
            ...
            if ((a = a.originalEvent)) {
              if (XF.supportsPointerEvents() && a instanceof PointerEvent)
          ...
          e || c
            ? a.each(function () {
                ...
                "undefined" == typeof d.data("base-z-index") &&
                  d.data("base-z-index", parseInt(d.css("z-index"), 10) || 0);
          ...
          e ||
            ...
            0 !== q.performance.timing.requestStart
              ? ((e = q.performance.timing),
                (e = Math.floor((e.requestStart + e.responseStart) / 2e3)))
        ...
        smoothScroll: function (a, b, c, f) {
          ...
          if (null === d) console.error("Invalid scroll position");
            ...
            try {
              e(),
                g("html, body").animate({ scrollTop: d }, c, function () {
                  b && !q.history.pushState && (q.location.hash = b);
                });
            } catch (h) {
              b && (q.location.hash = b);
            }
      ...
      (XF.Cookie = {
        ...
        isGroupConsented: function (a) {
          return "_required" === a || "_unknown" === a
            ? !0
            : XF.config.cookie.consented.includes(a);
        },
        isThirdPartyConsented: function (a) {
      ...
      (XF.JobRunner = (function () {
        var a = !1,
            ...
            e = XF.ajax(
              ...
              function (y) {
                y.more && y.ids && y.ids.length
                  ? (y.status && g("#xfAutoBlockingJobStatus").text(y.status),
                    setTimeout(function () {
                      k(y.ids);
                    }, 0))
          ...
          m = function () {
            ...
            f--;
            0 > f && (f = 0);
            0 == f && (g(r).trigger("job:auto-blocking-complete"), t());
            e && e.abort();
            e = null;
          },
          l = function () {
          ...
          n = function (v) {
            ...
            return new XF.Overlay(v, { backdropClose: !1, keyboard: !1 });
          },
          t = function () {
              ...
              if (!a) {
                ...
                var u = function (B) {
                    b = XF.ajax(
                      ...
                      function (A) {
                        A.jobRunner
                          ? (g("#xfManualJobStatus").text(
                              A.jobRunner.status || XF.phrase("processing...")
                            ),
                            setTimeout(function () {
                              u(B);
                            }, 0))
          ...
          c = function (f, e, d) {
            ...
            l
              ? (h.length &&
                ...
                k.length &&
                  ((f = XF.config.url.css)
                    ? ((f = f.replace("__SENTINEL__", k.join(","))),
                      g
                        .ajax({
                          type: "GET",
                          url: f,
                          ...
                          dataType: "text",
                          success: function (n) {
                            var t = XF.config.url.basePath;
                            t &&
                              (n = n.replace(
                                /(url\(("|')?)([^"')]+)(("|')?\))/gi,
                                function (x, v, y, w, u, z) {
                                  w.match(/^([a-z]+:|\/)/i) || (w = t + w);
                                  return v + w + u;
                                }
                              ));
                            g("<style>" + n + "</style>").appendTo("head");
                          },
                        })
                        .always(function () {
      ...
      (XF.ClassMapper = XF.create({
        ...
        getObjectFromIdentifier: function (a) {
          ...
          if ("string" == typeof b) {
            ...
            if (c) {
              for (var f = 0; f < c.length; f++) b = XF.extend(b, c[f]);
              ...
              -2 > B
                ? ((B = z - (b + x)),
                  60 > B
                    ...
                    ? ((z = Math.floor(B / 60)),
                      A !== "futureMinutes" + z &&
                        (u.text(XF.phrase("in_x_minutes", { "{minutes}": z })),
                ...
                : 60 >= B
                ? "moment" !== A &&
                  (u.text(XF.phrase("a_moment_ago")), (w.xfDynType = "moment"))
                : 120 >= B
                ? "minute" !== A &&
                ...
                ? ((z = Math.floor(B / 60)),
                  A !== "minutes" + z &&
                    (u.text(XF.phrase("x_minutes_ago", { "{minutes}": z })),
                ...
                ? "week" !== A &&
                  (u.text(
                    XF.phrase("day_x_at_time_y", {
                      "{day}": XF.phrase("day" + new Date(1e3 * z).getDay()),
                      "{time}": u.attr("data-time-string"),
                    })
                  ),
                  (w.xfDynType = "week"))
            ...
            c &&
              ...
              g
                .ajax({
                  ...
                  data: { _xfResponseType: "json", _xfToken: XF.config.csrf },
                  type: "post",
                  cache: !1,
                  dataType: "json",
                  global: !1,
                ...
                .done(function (l) {
                  "ok" == l.status && (m(l), XF.CrossTab.trigger(b, l));
                }));
          },
          m = function (l) {
            l.csrf &&
            ...
            if ("undefined" !== typeof l.user_id) {
              ...
              l.user_id == XF.config.userId && p.length && p.remove();
            }
            e();
          };
        return {
          ...
          initialize: function () {
            q.addEventListener("popstate", function (e) {
              ...
              for (var d = !1, h = 0; h < f.length; h++)
                f[h](e, b, c) && (d = !0);
              d ||
                c.replace(/#.*$/, "") === q.location.href.replace(/#.*$/, "") ||
                q.location.reload();
              b = e;
              c = q.location.href;
            });
      ...
      (XF.LinkWatcher = (function () {
        var a = function (c) {
          ...
          b = function (c) {
            if (XF.config.enableRtnProtect && !c.isDefaultPrevented()) {
              var f = g(this),
                e = f.attr("href"),
              ...
              if (
                ...
                if (
                  !(
                    f.closest("[contenteditable=true]").length ||
                    ...
                    new RegExp(
                      ...
                      (d && d == c.timeStamp) ||
                      (f.data("blank-handler-last", c.timeStamp),
                  ...
                  if (d)
                    (f = g('<iframe style="display: none" />').appendTo(
                      r.body
                    )),
                      (d = f[0].contentDocument || f[0].contentWindow.document),
                      (d.__href = e),
                      (e = g("<script />", d)),
                      (e[0].text =
          ...
          initLinkProxy: function () {
            ...
            g(r)
              ...
              .on("focusin", c, function (f) {
                f = g(this);
                f.data("proxy-handler") || f.data("proxy-handler", !0).click(a);
              });
          },
          initExternalWatcher: function () {
            g(r)
              ...
              .on("focusin", "a[target=_blank]", function (c) {
                c = g(this);
                c.data("blank-handler") || c.data("blank-handler", !0).click(b);
              });
          },
        };
      })()),
          ...
          if (!this.shown) {
            ...
            if (a.length)
              if (
                ...
                this.getLinks().each(function () {
                  g(this).removeAttr("title").removeClass("is-hidden");
                });
          }
        },
        getIgnored: function () {
          ...
          if (q.location.hash) {
            ...
            if ("#" !== a) {
              ...
              (b = a.is(b) ? a : a.closest(b)) &&
                b.length &&
                (b.removeClass("is-ignored"), a.get(0).scrollIntoView(!0));
            }
          }
        },
      })),
      ...
      (XF.MultiBar = XF.create({
        options: { role: null, focusShow: !1, className: "", fastReplace: !1 },
        $container: null,
        $multiBar: null,
        shown: !1,
      ...
      (XF.loadMultiBar = function (a, b, c, f) {
        ...
        var e = function (h) {
          ...
          c.show && h.show();
          c.afterShow &&
            ((k = g.Event()), c.afterShow(h, k), k.isDefaultPrevented());
        };
            ...
            h.html &&
              XF.setupHtmlInsert(h.html, function (k, m, l) {
                var p = new XF.MultiBar(
                  XF.getMultiBarHtml({ html: k, title: m.title || m.h1 }),
                  f
                );
                c.init && c.init(p);
                if (!c.cache)
          ...
          f = function () {
            var e = "right",
              d = b.hasClass("is-modalOpen")
                ...
                : "";
            XF.isRtl() &&
              (XF.browser.chrome || XF.browser.mozilla || (e = "left"));
            c.css("margin-" + e, d);
          };
        return {
          getOpenCount: function () {
      ...
      (XF.loadOverlay = function (a, b, c) {
        ...
        var f = function (d) {
          ...
          b.show && d.show();
          b.afterShow &&
            ((h = g.Event()), b.afterShow(d, h), h.isDefaultPrevented());
        };
      ...
      (XF.NavDeviceWatcher = (function () {
        function a(c) {
          c != b && (g("html").toggleClass("has-pointer-nav", !c), (b = c));
        }
        var b = !0;
        return {
          initialize: function () {
      ...
      (XF.ScrollButtons = (function () {
        ...
        return {
          initialize: function () {
            ...
            w.on({ "mouseenter focus": d, "mouseleave blur": h, click: k });
      ...
      (XF.KeyboardShortcuts = (function () {
        ...
        function b(d) {
          var h = String(g(d).data("xf-key")),
            ...
            m = "#" === k[0] ? k.substr(1) : k.toUpperCase().charCodeAt(0),
        ...
        function c(d) {
          ...
          if (
            ...
            var h =
              0 + d.ctrlKey ? 1 : 0 + d.altKey ? 2 : 0 + d.metaKey ? 4 : 0;
        ...
        isShortcutAllowed: function (a) {
          switch (a.tagName) {
            ...
            case "BODY":
              return !0;
            default:
              return XF.browser.msie && g(a).parents(".fr-element").length
                ? !1
      ...
      (XF.FormInputValidation = (function () {
        ...
        function f(d) {
          ...
          h[0] !== k[0] ||
            ...
            d.length
              ? d.scrollTop(
                  h.offset().top - d.offset().top + d.scrollTop() - 100
                )
      ...
      (XF.NoticeWatcher = (function () {
        return {
          getBottomFixerNoticeHeight: function () {
            var a = 0;
            g(r)
              .find(".js-bottomFixTarget .notices--bottom_fixer .js-notice")
              .each(function () {
                var b = g(this);
            ...
            XF.PWA.isSupported() &&
              (XF.config.skipServiceWorkerRegistration
                ? (h = new Promise(function (l, p) {
                    p(Error("Service worker registration has been skipped"));
                  }))
                : ((h = navigator.serviceWorker.register(a())),
                  ...
                  h.catch(function (l) {
                    console.error("Service worker registration failed:", l);
                  }),
                  navigator.serviceWorker.getRegistrations().then(function (l) {
                    var p = XF.canonicalizeUrl("js/xf/"),
                      n;
                    for (n in l) l[n].scope == p && l[n].unregister();
                  }),
                  navigator.serviceWorker.addEventListener(
                    ...
                    function (l) {
                      ...
                      if ("object" !== typeof p || null === p)
                        console.error("Invalid message:", p);
                      else if (
                        ((l = p.type),
                        (p = p.payload),
                        "string" !== typeof l || "" === l)
                  ...
                  b() &&
                    ...
                    g(r).on("click", ".js-skipPwaNavIndicator", f))));
          },
          isSupported: function () {
            null === d && (d = !!("serviceWorker" in navigator && a()));
            return d;
          },
          isRunning: b,
      ...
      (XF.Push = (function () {
              ...
              XF.Push.isSubscribed
                ? (g(r).trigger("push:init-subscribed"),
                  XF.config.userId && f(d)
                    ? XF.Push.updateUserSubscription(d, "update")
                    : (d.unsubscribe(),
                      XF.Push.updateUserSubscription(d, "unsubscribe")))
        ...
        function f(d) {
          d instanceof PushSubscription && (d = d.options.applicationServerKey);
          if ("string" === typeof d) return XF.config.pushAppServerKey === d;
          d.buffer && d.BYTES_PER_ELEMENT && (d = d.buffer);
          if (!(d instanceof ArrayBuffer))
            throw Error("input must be an array buffer or convertable to it");
        ...
        return {
            ...
            XF.Push.isSubscribed ||
              Notification.requestPermission().then(function (m) {
                if ("granted" !== m)
                  ...
                  var l = XF.Push.base64ToUint8(XF.config.pushAppServerKey);
                  XF.PWA.getRegistration().then(function (p) {
                    p.pushManager
                      ...
                      .then(function (n) {
                        XF.Push.updateUserSubscription(n, "insert");
                        ...
                        XF.config.publicMetadataLogoUrl &&
                          (n.icon = XF.config.publicMetadataLogoUrl);
                        XF.config.publicPushBadgeUrl &&
                          (n.badge = XF.config.publicPushBadgeUrl);
                        d ||
                          p.showNotification(
                      ...
                      .catch(function (n) {
                        console.error("Failed to subscribe the user: ", n);
                        k && k();
                      });
                  });
                }
          ...
          updateUserSubscription: function (d, h) {
            if ("update" !== h || !XF.Cookie.get("push_subscription_updated")) {
              var k = d.getKey("p256dh"),
                m = d.getKey("auth"),
                l = (PushManager.supportedContentEncodings || ["aesgcm"])[0];
              g.ajax({
                ...
                data: {
                  ...
                  key: k
                    ...
                    : null,
                  token: m
                    ? btoa(String.fromCharCode.apply(null, new Uint8Array(m)))
                    : null,
                  encoding: l,
                ...
                if (
                  ...
                  var p = new MutationObserver(function (n) {
                    c.hasClass("is-expanded")
                      ? p.disconnect()
                      : m && (k && clearTimeout(k), (k = setTimeout(l, 200)));
                  });
                  p.observe(this, {
                    attributes: !0,
                    childList: !0,
          ...
          watch: function () {
            g(r).on("click", ".js-expandLink", function (b) {
              g(b.target)
                ...
                .addClassTransitioned("is-expanded", XF.layoutChange);
            });
        ...
        return {
          activateContainer: function (e) {
            ...
            e.length &&
              (e.each(function () {
                var d = g(this);
                if (!1 === d.data("pending") || d.data("pending-seen"))
                  return !0;
          ...
          handleResponse: function (e) {
            var d = g('.js-unfurl[data-result-id="' + e.result_id + '"]');
            d.length &&
              (e.success
        ...
        var a = new XF.ClassMapper(),
            ...
            for (l = 0; l < k.length; l++) {
              ...
              if (p.length) {
                if (!m[p]) {
                  ...
                  if (!n) {
                    console.error("Could not find %s handler for %s", d, p);
                    continue;
                  }
                  var t = e.data("xf-" + p) || {};
                  m[p] = new n(e, t);
          ...
          f = XF.create({
            ...
            __construct: function (e, d) {
              this.$target = e;
              this.options = XF.applyDataOptions(this.options, e.data(), d);
            ...
            _init: function () {
              var e = new g.Event(
                  "xf-" + this.eventType + ":before-init." + this.eventNameSpace
                ),
                d = !1;
              ...
              e.isDefaultPrevented() ||
                ((d = this.init()),
                this.$target.trigger(
                  "xf-" + this.eventType + ":after-init." + this.eventNameSpace,
                  [this, d]
                ));
              this.initialized = !0;
              return d;
            ...
            _onEvent: function (e) {
              ...
              if (!d.isDefaultPrevented()) {
                ...
                else if ("function" == typeof this.onEvent) d = this.onEvent(e);
                else
                  return (
                    console.error(
        ...
        return {
          watch: function (e) {
            ...
            b.hasOwnProperty(e) ||
              ...
              g(r).on("pointerdown", "[data-xf-" + e + "]", function (h) {
                var k = h.currentTarget;
                d(h, k) && g(k).data("xf-pointer-type", h.pointerType);
              }));
          },
          initElement: c,
      ...
      (XF.Element = (function () {
        var a = new XF.ClassMapper(),
          ...
          e = XF.create({
            ...
            __construct: function (d, h) {
              this.$target = d;
              this.options = XF.applyDataOptions(this.options, d.data(), h);
            },
            init: function () {
              console.error(
        ...
        return {
          ...
          getHandler: function (d, h) {
            ...
            void 0 === k && (c(d), (k = d.data("xf-element-handlers")));
      ...
      (XF.AutoCompleteResults = XF.create({
        ...
        showResults: function (a, b, c, f) {
          ...
          if (b) {
            ...
            for (e in b)
              if (b.hasOwnProperty(e)) {
                ...
                this.options.clickAttacher
                  ? this.options.clickAttacher(h, XF.proxy(this, "resultClick"))
                ...
                if ("string" == typeof d) {
                  ...
                  "undefined" !== typeof d.icon
                    ? (k.icon = g('<img class="autoCompleteList-icon" />').attr(
                        "src",
                  ...
                  for (p in l)
                    if (l.hasOwnProperty(p)) {
                      var n = p.match(/Html$/),
                        t = n ? p.replace(/Html$/, "") : p;
                      n = n ? l[p] : XF.htmlspecialchars(l[p]);
                      k[t] = n;
                    }
                }
                ...
                h.html(
                  Mustache.render(this.options.displayTemplate, k)
            ...
            if (this.$results.children().length) {
              ...
              if (!this.resizeBound)
                g(q).onPassive("resize", XF.proxy(this, "hideResults"));
              this.$results.css({ top: "", left: "", right: "", bottom: "" });
              var x = this.$results,
                v = function (y) {
                  g.isFunction(y) && (y = y(x, c));
                  if (!y) {
                    var w = c.offset();
                    y = { top: w.top + c.outerHeight(), left: w.left };
                    XF.isRtl() &&
                      ((y.right = g("html").width() - w.left - c.outerWidth()),
                      (y.left = "auto"));
                  }
                  return y;
                };
        ...
        insertSelectedResult: function (a) {
          ...
          0 <= this.selectedResult &&
            ...
            this.options.beforeInsert && (c = this.options.beforeInsert(c, b)),
      ...
      (XF.AutoCompleter = XF.create({
        ...
        init: function () {
          ...
          this.ed
            ? (this.ed.events.on("keydown", XF.proxy(this, "keydown"), !0),
              this.ed.events.on("keyup", XF.proxy(this, "keyup"), !0),
              this.ed.events.on("click blur", XF.proxy(this, "blur")),
              g(this.ed.$wp).onPassive("scroll", XF.proxy(this, "blur")))
          ...
          if (this.visible)
            switch (a.which) {
              ...
              case 9:
                if (this.visible)
                  return (
                    this.results.insertSelectedResult(a), a.preventDefault(), !1
                  );
            }
        },
        keyup: function (a) {
              ...
              (d = this.$input),
                ...
                -1 !== c &&
                  ...
                  d.replaceSelectedText(
                    (this.options.keepAt ? this.options.at : "") + a + " ",
                    "collapseToEnd"
                  ));
          }
        },
            ...
            if (((this.visible = !0), this.ed)) {
              ...
              this.results.showResults(a, b, f, function (k) {
                if (!h || !h.getBoundingClientRect)
                  return (
                    ...
                    {
                      top:
                        (3 === k.nodeType ? g(k.parentNode) : g(k)).dimensions()
                          .bottom + 3,
                      left: e.left + 5,
                    }
                  );
              ...
              this.results.showResults(a, b, f, function (k) {
                for (
                  ...
                  (p = l[t]), (n += p + ": " + l.getPropertyValue(p) + "; ");
                m[0].style.cssText = n;
                m.css({
                  position: "absolute",
                  height: "",
                ...
                n.setStart(m[0].firstChild, c.start + 1 + c.query.length);
                n.setEnd(m[0].firstChild, c.start + 1 + c.query.length);
                t = n.getBoundingClientRect();
                n = e.left + (t.left - x.left);
                m.remove();
                return d.getResultPositionForSelection(l, p, n, k, e);
              });
        },
...
!(function (e, l, m, u) {
  XF.AttributionClick = XF.Event.newHandler({
    ...
    click: function (a) {
      var b = this.options.contentSelector,
        c = e(b);
      c.length &&
        (a.preventDefault(), XF.smoothScroll(c, b, XF.config.speed.normal));
    },
  });
  XF.LikeClick = XF.Event.newHandler({
    ...
    handleAjax: function (a) {
      var b = this.$target;
      b.trigger(
        "xf-" + this.eventType + ":before-handleAjax." + this.eventNameSpace,
        [this, a]
      );
      ...
      a.hasOwnProperty("isLiked") &&
        ...
        this.$container && this.$container.toggleClass("is-liked", a.isLiked));
      ...
      b.trigger(
        "xf-" + this.eventType + ":after-handleAjax." + this.eventNameSpace,
        [this, a]
      );
    },
  });
    ...
    if (b.switchKey) {
      ...
      if (d) {
        for (
          ...
          if (((d = d.substring(g[0].length)), (h = e.trim(g[3])), h.length))
            switch (g[2]) {
              case "addClass":
                a.addClass(h);
                break;
    ...
    init: function () {
      ...
      if (a && a.length)
        if (((this.$scroll = a), !0 === b || "true" === b))
          (a = a.attr("id")), (this.options.hash = a && a.length ? a : null);
        else {
      ...
      c.isDefaultPrevented() ||
        (a.html && a.html.content && this.options.overlayOnHtml
          ? XF.setupHtmlInsert(a.html, function (f, g) {
              ...
              f = XF.getOverlayHtml({ html: f, title: g.h1 || g.title });
              f.find("form").on(
          ...
          : (this.applyResponseActions(a),
            this.overlay && (this.overlay.hide(), (this.overlay = null))));
    },
  ...
  XF.SwitchOverlayClick = XF.Event.newHandler({
    ...
    setupOverlay: function (a) {
      ...
      a.getOverlay()
        .find("form")
        .on("ajax-submit:response", XF.proxy(this, "handleOverlaySubmit"));
      var b = this;
    ...
    handleOverlaySubmit: function (a, b) {
      "ok" == b.status &&
        ...
        XF.handleSwitchResponse(this.$target, b, this.options.redirect));
    },
  });
  XF.AlertsList = XF.Element.newHandler({
    ...
    _makeAjaxRequest: function (a, b, c) {
      if (!this.processing) {
        this.processing = !0;
        var d = this;
        XF.ajax("POST", a, c || {}, b, { skipDefaultSuccess: !0 }).always(
          function () {
            setTimeout(function () {
              d.processing = !1;
            }, 250);
  ...
  XF.Draft = XF.Element.newHandler({
    ...
    init: function () {
      if (this.options.draftUrl) {
        ...
        this.$target.on(this.options.deleteButton, "click", function (c) {
          c.preventDefault();
          a.triggerDelete();
        });
    ...
    completeAction: function (a) {
      ...
      if (!b.isDefaultPrevented() && !1 !== a.draft.saved) {
        ...
        c.removeClass("is-active").text(a.complete).addClass("is-active");
        setTimeout(function () {
  ...
  XF.ShareButtons = XF.Element.newHandler({
    ...
    init: function () {
      ...
      this.$target.find(a).each(function () {
        var c = e(this);
        b &&
          XF.Element.applyHandler(c, "element-tooltip", { element: "> span" });
        c.data("clipboard") &&
          navigator.clipboard &&
    ...
    setupPageData: function () {
      this.options.pageTitle && this.options.pageTitle.length
        ...
        : ((this.pageTitle = e('meta[property="og:title"]').attr("content")),
      ...
      if (this.options.pageUrl && this.options.pageUrl.length)
        ...
        this.pageUrl ||
          (this.pageUrl = e('meta[property="og:url"]').attr("content"));
      ...
      this.options.pageImage && this.options.pageImage.length
        ...
        : ((this.pageImage = e('meta[property="og:image"]').attr("content")),
          this.pageImage ||
  ...
  XF.WebShare = XF.Element.newHandler({
    ...
    hideContainerElements: function () {
      if (this.options.hideContainerEls) {
        ...
        a.length &&
          (a.find(".shareButtons").removeClass("shareButtons--iconic"),
    ...
    setupShareData: function () {
      this.fetchUrl ||
        (this.options.url
          ...
          : ((this.url = e('meta[property="og:url"]').attr("content")),
            this.url || (this.url = l.location.href)),
        this.options.title
          ? (this.title = this.options.title)
          : ((this.title = e('meta[property="og:title"]').attr("content")),
            this.title || (this.title = e("title").text())),
        this.options.text
          ? (this.text = this.options.text)
          : ((this.text = e('meta[property="og:description"]').attr("content")),
            this.text ||
              (this.text = e("meta[name=description]").attr("content") || "")));
    },
    click: function (a) {
      a.preventDefault();
      if (this.fetchUrl) {
  ...
  XF.PushCta = XF.Element.newHandler({
          ...
          if (XF.Push.hasUserPreviouslySubscribed())
            ...
            a.getDismissCookie() ||
              a.$target
                ...
                .xfFadeDown(XF.config.speed.fast, XF.proxy(a, "initLinks"));
        });
      });
    },
    initLinks: function () {
    ...
    setDismissCookie: function (a, b) {
      a
        ? (b || (b = 31536e7),
          XF.Cookie.set("push_notice_dismiss", "1", new Date(Date.now() + b)))
        : XF.Cookie.set("push_notice_dismiss", "1");
    },
  ...
  XF.BookmarkClick = XF.Event.newHandler({
    ...
    getTooltipContent: function (a) {
      if (this.$tooltipHtml && !this.tooltip.requiresLoad())
        return this.initializeTooltip(this.$tooltipHtml), this.$tooltipHtml;
      var b = this,
  ...
  XF.ContentVote = XF.Element.newHandler({
    ...
    handleAjax: function (a) {
      ...
      if (this.options.contentId) {
        var b = e(
            '.js-contentVote[data-content-id="' + this.options.contentId + '"]'
          ),
          c = this,
          d = this.$target;
        b.each(function () {
          if (d[0] !== this) {
            ...
            f.is('[data-xf-init~="content-vote"]')
              ? XF.Element.getHandler(f, "content-vote").updateData(a)
              : c.updateDisplay(f, a);
          }
        });
      }
...
!(function (e, p, q) {
          ...
          setTimeout(function () {
            ...
            g
              ? (h = b
                  ...
                  .serializeArray())
              : (h[b.attr("name")] = b.prop("checked") ? b.attr("value") : f);
            XF.ajax("POST", d, h);
          }, 0);
        } else
          c
            ? ((a = c.data("submit-click-timer")) && clearTimeout(a),
              c.one("ajax-submit:complete", function (h, k, m) {
                if (k.errors)
                  b.prop("checked", b.prop("checked") ? "" : "checked");
                else if (
                  "checkbox" == b.attr("type") &&
                  null !== b.closest("tr.dataList-row")
                )
                  b.closest("tr.dataList-row")[
                    b.prop("checked") ? "removeClass" : "addClass"
  ...
  XF.AjaxSubmit = XF.Element.newHandler({
    ...
    submit: function (a) {
      ...
      if (
        !(
          (this.$submitButton && this.$submitButton.data("prevent-ajax")) ||
    ...
    submitResponse: function (a, b, c) {
      if ("object" != typeof a) XF.alert("Response was not JSON.");
        ...
        if (!d.isDefaultPrevented()) {
          ...
          c && c.attr("data-ajax-redirect") && (h = c.data("ajax-redirect"));
          if (a.errorHtml)
            b.trigger(d, a, this),
            ...
            XF.setupHtmlInsert(a.html, function (l, n, r) {
              if (m.options.replace && m.doSubmitReplace(l, r)) return !1;
              k && k.trigger("overlay:hide");
              l = XF.getOverlayHtml({ html: l, title: n.h1 || n.title });
              XF.showOverlay(l);
            });
          } else
            "ok" == a.status &&
              (h && XF.redirect(a.redirect), k && k.trigger("overlay:hide"));
          !f && a.flashMessage && XF.flashMessage(a.flashMessage, 3e3);
    ...
    doSubmitReplace: function (a, b) {
      ...
      else (g = this.$target.find(c).first()), g.length || (g = e(c).first());
      if (!g.length)
        return console.error("Could not find old selector '" + c + "'"), !1;
      var f = a.is(d) ? a : a.find(d).first();
      if (!f.length)
        return console.error("Could not find new selector '" + d + "'"), !1;
  ...
  XF.ChangeSubmit = XF.Element.newHandler({
    ...
    initForm: function () {
      this.formInitialized ||
        ...
        (XF.Element.getHandler(this.$target, "ajax-submit").options.redirect =
          !1));
    },
    change: function (a) {
      this.initForm();
    ...
    scheduleSubmit: function () {
      ...
      0 < a
        ? (this.clearSubmitTimeout(),
          (this.delayTimeout = setTimeout(XF.proxy(this, "triggerSubmit"), a)))
        : this.triggerSubmit();
    },
    ...
    validateGroup: function (a) {
      ...
      this.$target.find("[data-group='" + a + "']").each(function () {
        if (e(this).data("required") && "" === e(this).val()) return (b = !1);
      });
      return b;
    },
    revert: function (a) {
  ...
  XF.AutoComplete = XF.Element.newHandler({
    ...
    addValue: function (a) {
      if (this.options.single) this.$target.val(a);
        ...
        "" != a &&
          (b.length && (a = " " + a), b.push(a + this.options.multiple + " "));
        this.$target.val(b.join(this.options.multiple));
      }
      this.$target
        .trigger("change")
        .trigger("auto-complete:insert", {
          inserted: e.trim(a),
  ...
  XF.SelectPlus = XF.Element.newHandler({
    ...
    init: function () {
      this.$checkboxes = this.$target.find(
        this.options.spCheckbox ? this.options.spCheckbox : "input:checkbox"
      );
      ...
      if (this.$containers.length != this.$checkboxes.length)
        ...
        this.$containers.on("mousedown", function (b) {
          if (
            ...
            (b.preventDefault(), -1 !== navigator.userAgent.indexOf("MSIE"))
          ) {
    ...
    checkboxClick: function (a) {
      if (!this.ignoreClick) {
        ...
        a.delegateTarget.checked && this.isShifted && null !== this.lastSelected
          ? ((this.ignoreClick = !0),
    ...
    checkboxEnter: function (a) {
      this.isActive &&
        ((this.lastEntered = this.$checkboxes.index(
          e(a.delegateTarget).find("input:checkbox").eq(0)
        )),
    ...
    setActive: function (a) {
      ...
      this.isActive != b &&
        ...
        this.$target
          .trigger(
            this.isActive ? "selectplus:activate" : "selectplus:deactivate",
            [this]
          )
          .toggleClassTransitioned(this.options.activeClass, this.isActive),
        e(q.body).toggleClassTransitioned("is-spDocTriggered", this.isActive));
    },
    ...
    redrawHover: function () {
      ...
      if (
        ...
        this.$containers.toggleClassTransitioned(this.options.hoverClass, !1);
    },
    ...
    init: function () {
      ...
      if (a.is(":radio")) {
        var c = b,
          d = a.attr("name");
        b.length || (c = e(q.body));
        c.on("click", 'input:radio[name="' + d + '"]', XF.proxy(this, "click"));
      } else if (a.is("option")) {
        var g = this;
        a.closest("select").on("change", function (f) {
          ...
          (!f.find("option:selected").first().is(g.$target) &&
            h &&
      ...
      this.$target
        ...
        .each(function () {
          ...
          b.is("select")
            ...
            : b.val(b.data("default-value") || this.defaultValue || "");
        });
      ...
      if (!this.created && ((this.created = !0), 0 != this.options.remaining)) {
        ...
        if (this.options.incrementFormat) {
          ...
          this.$clone.find("input, select, textarea").each(function () {
            ...
            g = g.replace(c, function (f, h) {
              return a.replace("{counter}", parseInt(h, 10) + 1);
            });
            d.attr("name", g);
          });
        }
        ...
        this.$clone.find("input, select, textarea").each(function () {
          ...
          d.is("select")
            ...
            : "string" === typeof this.defaultValue && d.val(this.defaultValue);
        });
  ...
  XF.FormSubmitRow = XF.Element.newHandler({
      ...
      if (XF.config.enableFormSubmitSticky) {
        ...
        b.length
          ? ((this.$container = b),
            ...
            e(q.body).on("xf:layout", XF.proxy(this, "recalcAndUpdate")),
            a.height() || setTimeout(XF.proxy(this, "recalcAndUpdate"), 250),
    ...
    update: function () {
      var a =
        XF.browser.ios || XF.browser.android ? p.innerHeight : this.winHeight;
      if (a < this.options.minWindowHeight)
        "normal" != this.state && (this.resetTarget(), (this.state = "normal"));
      else {
        ...
        if (a >= this.elBottom)
          ...
          a <= c
            ? c >= this.elBottom ||
              ...
              "stuck" == this.state
                ? ((b = this.$fixEl.parent()),
                  "static" == b.css("position") && (b = b.offsetParent()))
  ...
  XF.PermissionMatrix = XF.Element.newHandler({
    ...
    update: function () {
      ...
      -1 < e.inArray(a, this.values) &&
        ((this.currentClass =
          this.options.classPrefix + this.options.permissionType + "-" + a),
  ...
  XF.MultiCheck = XF.Event.newHandler({
    ...
    init: function () {
      ...
      this.currentValue =
        0 < e.inArray(a, this.values) ? this.values[-1] : this.values[0];
    },
    click: function (a) {
      var b = this.values[e.inArray(this.currentValue, this.values) + 1];
      void 0 === b && (b = this.values[0]);
      this.$target.each(function () {
        e(this).val() == b && e(this).prop("checked", !0).trigger("click");
      });
      this.currentValue = b;
    },
  });
    ...
    handleResponse: function (a) {
      if (
        ...
        if (!a.inputValid && b) {
          ...
          this.$errorElement.html(c).addClassTransitioned("is-active");
        } else {
      ...
      this.$checkboxes.each(function () {
        ...
        a.find('option[value="' + this.value + '"]').each(function () {
          ...
          !c &&
            ...
            (d.prop("selected", !1),
            h.attr("multiple") ||
              h.find("option:enabled").first().prop("selected", !0),
            (k = !0));
          k && b.push(h[0]);
        });
      });
...
!(function (f, m, p) {
  ...
  XF.Inserter = XF.create({
    ...
    onEvent: function (a, b) {
      ...
      if (!this.loading) {
        ...
        var c = this;
        XF.ajax("get", this.href, b || {}, XF.proxy(this, "onLoad")).always(
          function () {
            c.loading = !1;
          }
        );
    ...
    _applyAfter: function (a, b, c) {
      b.length &&
        c.length &&
        (c.insertAfter(b), XF.activate(c), this._removeOldSelector(a, b));
    },
    ...
    _applyBefore: function (a, b, c) {
      b.length &&
        c.length &&
        (c.insertBefore(b), XF.activate(c), this._removeOldSelector(a, b));
    },
  ...
  XF.MenuClick = XF.Event.newHandler({
          ...
          if (!b.data("menu-loading")) {
            ...
            XF.ajax(
              ...
              function (l) {
                k && b.data("href", !1);
                l.html &&
                  XF.setupHtmlInsert(l.html, function (n, q, r) {
                    (q = b.data("load-target"))
                      ? b.find(q).first().empty().html(n)
                      : b.html(n);
                    g.$target.trigger("menu:loaded", [n, b]);
    ...
    repositionFixed: function (a) {
      ...
      if (a && XF.isIOS()) {
        ...
        if (d && this.menuRef.left == d[0] && this.menuRef.width == d[1]) {
          d = f(m).viewport();
          var e = this.$target.hasFixedParent() ? "fixed" : "absolute",
          ...
          a = setTimeout(function () {
            b.css({ "transition-property": "", "transition-duration": "" });
          }, 250);
    ...
    getHorizontalPosition: function (a, b) {
      ...
      this.$target.data("menu-h", [this.menuRef.left, this.menuRef.width, d]);
      this.$menu.toggleClass("menu--left", !c).toggleClass("menu--right", c);
      a = Math.min(
        this.arrowRef.left - this.menuRef.left + this.arrowRef.width / 2 - d,
        this.menuWidth - 20
      );
    ...
    keyboardEvent: function (a) {
      if (
        ...
        XF.Keyboard.isShortcutAllowed(p.activeElement) &&
        f(p.activeElement).closest(".menu").get(0) == this.$menu.get(0)
      ) {
        var b = f(p.activeElement),
  ...
  XF.OffCanvasClick = XF.Event.newHandler({
    ...
    init: function () {
      ...
      if (this.$menu.length) {
        this.$menu
          .on("click", "[data-menu-close]", XF.proxy(this, "closeTrigger"))
  ...
  XF.OverlayClick = XF.Event.newHandler({
    ...
    show: function () {
      if (this.overlay) this.overlay.show();
        ...
        this.loading = !0;
        var a = this,
          b = this.getLoadOptions();
        (b = XF.loadOverlay(this.loadUrl, b, this.options.overlayConfig))
          ? b.always(function () {
              setTimeout(function () {
                a.loading = !1;
              }, 300);
    ...
    getOverlayHtml: function () {
      ...
      (c && c.length) ||
        ((a = a.attr("href")) && "#" == a.substr(0, 1) && (c = f(a).eq(0)));
  ...
  XF.ToggleStorage = XF.Element.newHandler({
    ...
    init: function () {
      ...
      if (!b)
        throw Error("Storage key not specified for ToggleStorage handler");
  ...
  XF.HScroller = XF.Element.newHandler({
    ...
    init: function () {
      ...
      if (a.length) {
        ...
        a.on("mousedown.horizontalScroller", function (l) {
          l.button ||
            ...
            XF.isEventTouchTriggered(l) &&
              ((l = f(p.activeElement)), l.is(":input") && l.blur()),
            f(m)
              ...
              .on("mousemove.horizontalScroller", function (n) {
                var q = b - n.clientX;
                0 != q && (d.move(q) && (c = !0), (b = n.clientX));
              }));
        })
          .on("click.horizontalScroller", function (l) {
            c && (l.preventDefault(), l.stopImmediatePropagation(), (c = !1));
          })
          .on("scroll.horizontalScroller", XF.proxy(this, "updateScroll"))
        ...
        this.$goStart = f(
          '<i class="' + e + " " + e + '--start" aria-hidden="true" />'
        )
          .click(function () {
            d.step(-1);
          })
        ...
        this.$goEnd = f(
          ...
          .insertAfter(a);
        this.updateScroll();
        f(p.body).on("xf:layout", XF.proxy(this, "updateScroll"));
        var g;
    ...
    step: function (a) {
      var b = Math.max(125, Math.floor(0.25 * this.$scrollTarget.width())),
        c = "+=";
  ...
  XF.ResponsiveDataList = XF.Element.newHandler({
    ...
    init: function () {
      ...
      this.process();
      f(p).on("breakpoint:change", XF.proxy(this, "process"));
    },
    process: function () {
  ...
  XF.StickyHeader = XF.Element.newHandler({
            ...
            n < e || (n == e && 0 < m.scrollY)
              ...
              : d &&
                (g && l
                  ...
                  : (a.removeClass(b), XF.layoutChange(), (d = !1)));
          };
    ...
    _disable: function () {
      ...
      a.removeClass(b).removeClass(c).addClass(d);
    },
  });
      ...
      b.length && c.length
        ? (this.$tabs
          ...
          this.$panes
            ...
            .attr("aria-expanded", "false")
            .trigger("tab:hidden"),
          b.addClass(d).attr("aria-selected", "true").trigger("tab:shown"),
          c.addClass(d).attr("aria-expanded", "true").trigger("tab:shown"),
          XF.layoutChange(),
          c.data("href") &&
            !c.data("tab-loading") &&
        ...
        ? ((this.$input = XF.findRelativeIf(
          ...
          this.$input.length
            ? (this.$input.on("keyup", function (b) {
              ...
              XF.findRelativeIf(this.options.pageSubmit, this.$target).on(
                "click",
                function (b) {
                  b.preventDefault();
                  a.go();
  ...
  XF.QuickSearch = XF.Element.newHandler({
    ...
    updateSelectWidth: function () {
      if (this.$select.length) {
        ...
        b = f("<div />");
        b.css({ position: "absolute", top: -200, visibility: "hidden" });
  ...
  XF.VideoInit = XF.Element.newHandler({
    ...
    hasSeeked: function () {
      ...
      if (a) {
        var e = this;
        a.toBlob(function (g) {
          g && ((g = URL.createObjectURL(g)), e.$target.attr("poster", g));
        });
      }
    },
  });
  XF.CookieConsentClick = XF.extend(XF.OverlayClick, {
    __backup: { getLoadOptions: "_getLoadOptions" },
    options: f.extend({}, XF.OverlayClick.prototype.options, {
      cache: !1,
      followRedirects: !0,
    }),
    getLoadOptions: function () {
      var a = this._getLoadOptions(),
        b = a.onRedirect;
      a.onRedirect = function (c, d) {
  ...
  XF.CookieConsentForm = XF.Element.newHandler({
    options: { container: "article.message" },
    $embedHtml: null,
    $container: null,
    $anchor: null,
    replace: !1,
    init: function () {
      var a = this.$target.closest(this.options.container);
      a.length &&
        ((a = a.find(".u-anchorTarget")), a.length && (this.$anchor = a));
      this.$embedHtml = this.$target.find(".js-embedHtml");
      this.$embedHtml.length && (this.replace = this.supportsTemplateElement());
      this.$target.on("ajax-submit:response", XF.proxy(this, "response"));
      f(p).on("cookie-consent:load", XF.proxy(this, "load"));
    },
    response: function (a, b) {
      b.unconsented_local_storage &&
        XF.LocalStorage.removeMultiple(b.unconsented_local_storage);
      if (b.group_consent_state)
        for (let c in b.group_consent_state)
          p.querySelector(".js-consent_" + c).checked =
            b.group_consent_state[c];
      f(p).trigger("cookie-consent:load", [this.$target]);
    },
    load: function (a, b) {
      this.replace &&
        this.$embedHtml[0] &&
        (this.$target[0].replaceWith(this.$embedHtml[0].content.cloneNode(!0)),
        this.$target === b && this.$anchor && this.$anchor[0].scrollIntoView());
    },
    supportsTemplateElement: function () {
      return "content" in p.createElement("template");
    },
  });
  ...
  XF.DuplicatorClick = XF.Event.newHandler({
    ...
    click: function (a) {
      this.$targetElement.length &&
        ((a = this.$targetElement.clone(!0).insertAfter(this.$targetElement)),
        XF.layoutChange(),
        this.$targetElement.closest("[data-xf-init~=list-sorter]").length &&
          f(m).trigger("listSorterDuplication", a));
    },
  });
  ...
  f(p).on("xf:page-load-complete", function () {
    ...
    a &&
      ...
      a.length &&
        ...
        a.length &&
          ...
          a.length &&
            (a = XF.Event.getElementHandler(a, "toggle", "click")) &&
            a.show(!0))));
  });
})(jQuery, window, document);
("use strict");
!(function (f, m, p) {
  XF.TooltipElement = XF.create({
    ...
    hide: function () {
      if (this.shown) {
        ...
        var a = this.$tooltip;
        a &&
          (a.stop().fadeOut("fast").trigger("tooltip:hidden"),
      ...
      if (!a) console.error("No tooltip positioner");
        ...
        if (a instanceof f) {
          ...
          "undefined" !== typeof a[0] && "undefined" !== typeof a[1]
            ? (c = { top: a[1], right: a[0], bottom: a[1], left: a[0] })
            : "undefined" !== typeof a.right && "undefined" !== typeof a.bottom
            ? (c = a)
            : console.error("Positioner is not in correct format", a);
        ...
        switch (d) {
          ...
          case "left":
            ...
            break;
          default:
            (l.top = c.top + c.height / 2 - k / 2), (l.left = c.right);
        }
        a.css(l);
        g = a.dimensions(!0);
        k = c = 0;
    ...
    applyTooltipContent: function () {
      ...
      f.isFunction(c) && (c = c());
      this.options.html
        ? (b.html(c), b.find("img").on("load", XF.proxy(this, "reposition")))
        : b.text(c);
    ...
    getTemplate: function () {
      ...
      return f(
        f.parseHTML(
          '<div class="' +
            a +
            (this.options.extraClass ? " " + this.options.extraClass : "") +
  ...
  XF.TooltipTrigger = XF.create({
    ...
    init: function () {
      ...
      for (var g = this.options.trigger.split(" "), k = 0; k < g.length; k++)
        switch (g[k]) {
          case "hover":
            ...
            (c = !0),
              ...
              a.onPointer({
                ...
                "contextmenu.tooltip": function (e) {
                  a.data("tooltip:touching") && e.preventDefault();
                },
              });
        }
    ...
    addCovers: function () {
      ...
      for (var c, d = 0; d < b.length; d++)
        (c = f('<div class="tooltipCover" />').css(b[d])), (a = a.add(c));
    ...
    docClick: function (a) {
      ...
      b &&
        ...
        (c = f(p.elementFromPoint(c - h.scrollLeft(), d - h.scrollTop()))),
    ...
    focusEnter: function (a) {
      100 > Date.now() - XF.pageDisplayTime ||
        XF.isEventTouchTriggered(a) ||
        ((!this.stopFocusBefore || Date.now() >= this.stopFocusBefore) &&
          this.enter());
    },
    enter: function () {
      if (!this.isShown() || !this.clickTriggered) {
        ...
        if (a) {
          if (
            ("enter" !== this.delayTimeoutType && this.resetDelayTimer(),
    ...
    leave: function () {
      if (!this.clickTriggered) {
        ...
        if (a) {
          if (
            ("leave" !== this.delayTimeoutType && this.resetDelayTimer(),
            !this.delayTimeoutType && this.isShown())
          ) {
    ...
    resetDelayTimer: function () {
      this.delayTimeoutType &&
        (clearTimeout(this.delayTimeout), (this.delayTimeoutType = null));
    },
    addMaintainElement: function (a) {
      if (!a.data("tooltip-maintain")) {
        for (var b = this.options.trigger.split(" "), c = 0; c < b.length; c++)
          switch (b[c]) {
            case "hover":
            ...
            case "focus":
              a.on("focusin.tooltip", XF.proxy(this, "enter")),
                a.on("focusout.tooltip", XF.proxy(this, "leave"));
          }
        ...
        if (a) {
          ...
          c.length
            ? ((this.$element = c),
              ...
              (this.options.html = !0),
              this._init())
            : b && console.error("Element tooltip could not find " + a);
        } else
          b && console.error("No element specified for the element tooltip");
      }
    },
